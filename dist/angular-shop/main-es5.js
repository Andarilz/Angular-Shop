...
var CartComponent = /** @class */ (function () {
    function CartComponent(productService, router, orderService) {
    ...
    CartComponent.prototype.submit = function () {
        ...
        this.orderService.create(order).subscribe(function () {
            ...
            _this.ended = 'Доставка оформлена';
        });
    };
...
var MainPageComponent = /** @class */ (function () {
    function MainPageComponent(productService) {
        this.productService = productService;
    }
...
var ProductPageComponent = /** @class */ (function () {
    ...
    ProductPageComponent.prototype.addProduct = function (product) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.setToken = function (res) {
        if (res) {
            var expData = new Date(new Date().getTime() + +res.expiresIn * 1000);
    ...
    Object.defineProperty(AuthService.prototype, "token", {
        get: function () {
            var expData = new Date(localStorage.getItem('fb-token-exp'));
            if (new Date() > expData) {
                this.logout();
                return null;
            }
...
var CortingPipe = /** @class */ (function () {
    function CortingPipe() {
    }
    CortingPipe.prototype.transform = function (products, type) {
        if (type === void 0) { type = ''; }
...
var MainLayoutComponent = /** @class */ (function () {
    function MainLayoutComponent(router, productService) {
        this.router = router;
        this.productService = productService;
        this.type = 'Phone';
    }
    ...
    MainLayoutComponent.prototype.setType = function (type) {
        this.type = type;
        if (this.type !== 'Cart') {
...
var OrderService = /** @class */ (function () {
    ...
    OrderService.prototype.create = function (order) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + "/orders.json", order)
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, order, { id: res.name, date: new Date(order.date) });
        }));
    };
    OrderService.prototype.getAll = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + "/orders.json")
            ...
            return Object.keys(res)
                .map(function (key) { return (tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, res[key], { id: key, data: new Date(res[key].date) })); });
        }));
    };
...
var ProductService = /** @class */ (function () {
    ...
    ProductService.prototype.create = function (product) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + "/products.json", product)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, product, { id: res.name, date: new Date(product.date) });
        }));
    };
    ...
    ProductService.prototype.getById = function (id) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].URL + "/products/" + id + ".json")
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (res) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, res, { id: id, data: new Date(res.date) });
        }));
    };
    ...
    ProductService.prototype.setType = function (type) {
        this.type = type;
    };

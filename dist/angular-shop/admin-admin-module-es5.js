...
var AddPageComponent = /** @class */ (function () {
    function AddPageComponent(productService, router) {
    ...
    AddPageComponent.prototype.submit = function () {
        ...
        this.productService.create(product).subscribe(function (res) {
            console.log(res);
            _this.form.reset();
    ...
    AddPageComponent.ctorParameters = function () { return [
...
var DashboardPageComponent = /** @class */ (function () {
    function DashboardPageComponent(productService) {
        this.productService = productService;
        this.products = [];
    }
    DashboardPageComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pSub = this.productService.getAll().subscribe(function (products) {
    ...
    DashboardPageComponent.prototype.delete = function (id) {
        var _this = this;
        this.rSub = this.productService.remove(id).subscribe(function () {
...
var EditPageComponent = /** @class */ (function () {
    function EditPageComponent(productService, route, router) {
        this.productService = productService;
        this.route = route;
        this.router = router;
        this.submitted = false;
    ...
    EditPageComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(function (params) {
            return _this.productService.getById(params['id']);
    ...
    EditPageComponent.prototype.submit = function (event) {
        var _this = this;
        if (this.form.invalid) {
            return;
        }
        this.submitted = true;
        this.productService.update(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({}, this.product, { type: this.form.value.type, title: this.form.value.title, photo: this.form.value.photo, info: this.form.value.info, price: this.form.value.price, date: new Date() })).subscribe(function (res) {
            _this.submitted = false;
            _this.router.navigate(['/admin', 'dashboard']);
        });
    };
...
var LoginPageComponent = /** @class */ (function () {
    ...
    LoginPageComponent.prototype.submit = function (event) {
        var _this = this;
        if (this.form.invalid) {
            return;
        }
...
var OrdersComponent = /** @class */ (function () {
    ...
    OrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.pSub = this.orderService.getAll().subscribe(function (orders) {
            _this.orders = orders;
        });
    };
    ...
    OrdersComponent.prototype.delete = function (id) {
        var _this = this;
        this.rSub = this.orderService.remove(id).subscribe(function () {
            _this.orders = _this.orders.filter(function (prod) { return prod.id !== id; });
        });
    };
...
var SearchPipe = /** @class */ (function () {
    ...
    SearchPipe.prototype.transform = function (products, prodName) {
